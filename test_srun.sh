...
# Node feature:
#SRUN --constraint="gpu"
#SRUN --gres=gpu:rtx5000:2       # If using only 1 GPU of a shared node
#SRUN --mem=92500
#
# Number of nodes and MPI tasks per node:
#SRUN --nodes=1
#SRUN --ntasks-per-node=1     # This stays 1 for 2 GPU training too, in most cases
#SRUN --cpus-per-task=16      # Number of processes ?? (Each GPU has 16 workers ??)
#
#
# wall clock limit:
#SRUN --time=1:00:00         #Specify a smaller duration if your script takes less time
